            ...
            <div class="header">
                <div style="display:flex;align-items:stretch;justify-content:space-between;gap:12px;">
                    ...
                    <div style="flex:0 0 auto;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:8px;min-width:36px;">
                        <a href="https://github.com/Judzim/Cz-SkTorrent-Stremio-Addon" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:center;width:28px;height:28px;color:#888;transition:color 0.2s;" title="GitHub">
                        ...
                        <a href="https://ko-fi.com/judzim" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:center;width:28px;height:28px;color:#ff5e5b;transition:color 0.2s;" title="Ko-fi">
                            <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22"><path d="M23.881 8.948c-.773-4.085-4.859-4.593-4.859-4.593H.723c-.604 0-.679.798-.679.798s-.082 7.324-.022 11.822c.164 2.424 2.586 2.672 2.586 2.672s8.267-.023 11.966-.049c2.438-.426 2.683-2.566 2.658-3.734 0 0 3.326-1.049 4.686-4.015 1.262-2.755.835-4.965.835-4.965s-.5-1.145-.894-2.448zm-6.739 9.138H3.534V6.892h13.608v11.194zm2.05-11.562c-.229 1.206-.623 2.857-.623 2.857h-5.218V6.524h5.841z"/></svg>
                        </a>
                    </div>
                </div>
            </div>
